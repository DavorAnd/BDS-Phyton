...
with st.expander("**How to Use the Dashboard** 📚"):
    st.markdown("""
                ...
                🔍 Filter Data - Use the sidebar filters to zoom in on the juicy details and uncover the secrets hidden in plots. It's time to narrow down your investigation! It's like searching for gold in the Yukon, but with data!
